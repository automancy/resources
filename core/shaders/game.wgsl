...
struct InstanceInput {
    ...
    @location(5) model_matrix_index: u32,
    @location(6) world_matrix_index: u32,
    @location(7) animation_matrix_index: u32,
}
...
fn vs_main(
    ...
    out.albedo = vec4(mix(instance.color_offset.rgb, in.color.rgb, in.color.a - instance.color_offset.a), in.color.a * instance.alpha);
...
fn fs_main(in: VertexOutput) -> FragmentOutput {
    ...
    // [0~1]
    var model_xy = (in.model_pos.xy - ubo.camera_bounds.xy) / (ubo.camera_bounds.zw - ubo.camera_bounds.xy);
    // [-1~1]
